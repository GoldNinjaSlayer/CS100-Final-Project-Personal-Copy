...
//            // cout << "TEMP BOARD MINIMAXSTART" << endl;
    ...
    //size_t num_heuristics = heuristics.size();

    //for(size_t i = num_heuristics -1; i>= 0; i--){
...
//
//    size_t num_moves = possible_moves.size();
...
//            int result = (int)minimax(tempBoard, switchColor(col), !maximizing, depth - 1, alpha, beta);
...
//
//    size_t numBlack = blackPieces.size();
//    size_t numRed = redPieces.size();
//
//    int numBlackKings = 0;
//    int numRedKings = 0;
